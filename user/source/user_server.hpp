...
//用户管理子服务主要就是实现 用户名 - 密码  或者 手机号 - 验证码的 登录 和 注册 同时提供 用户名 签名 头像 手机号 密码 等的修改
//对应的信息就是：用户信息的新增 用户信息的获取（获取单个或者多个用户信息）通过昵称获取用户信息 通过手机号获取用户信息 通过用户ID获取用户信息
// 用户信息的获取（昵称 手机号 用户id 用户名）（这三个是通过es实现 可以实现通过关键字获取单个或者多个用户的信息）
//信息删除

namespace hu{
class UserServiceImpl : public hu::UserService {
    public:
        ...
        virtual void UserRegister(::google::protobuf::RpcController* controller,
            const ::hu::UserRegisterReq* request,
            ::hu::UserRegisterRsp* response,
        ...
        virtual void UserLogin(::google::protobuf::RpcController* controller,
            const ::hu::UserLoginReq* request,
            ::hu::UserLoginRsp* response,
            ::google::protobuf::Closure* done){
            LOG_DEBUG("收到用户登录请求！");
            brpc::ClosureGuard rpc_guard(done);
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void GetPhoneVerifyCode(::google::protobuf::RpcController* controller,
            const ::hu::PhoneVerifyCodeReq* request,
            ::hu::PhoneVerifyCodeRsp* response,
            ::google::protobuf::Closure* done){
        ...
        virtual void PhoneRegister(::google::protobuf::RpcController* controller,
            const ::hu::PhoneRegisterReq* request,
            ::hu::PhoneRegisterRsp* response,
            ::google::protobuf::Closure* done){
            LOG_DEBUG("收到手机号注册请求！");
            brpc::ClosureGuard rpc_guard(done);
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void PhoneLogin(::google::protobuf::RpcController* controller,
            const ::hu::PhoneLoginReq* request,
            ::hu::PhoneLoginRsp* response,
            ::google::protobuf::Closure* done){
            LOG_DEBUG("收到手机号登录请求！");
            brpc::ClosureGuard rpc_guard(done);
            auto err_response = [this, response](const std::string &rid, 
        ...
        virtual void GetUserInfo(::google::protobuf::RpcController* controller,
            const ::hu::GetUserInfoReq* request,
            ::hu::GetUserInfoRsp* response,
            ::google::protobuf::Closure* done){
            ...
            if (!user->avatar_id().empty()) {
                ...
                hu::FileService_Stub stub(channel.get());
                hu::GetSingleFileReq req;
                hu::GetSingleFileRsp rsp;
        ...
        virtual void GetMultiUserInfo(::google::protobuf::RpcController* controller,
            const ::hu::GetMultiUserInfoReq* request,
            ::hu::GetMultiUserInfoRsp* response,
            ::google::protobuf::Closure* done){
            ...
            hu::FileService_Stub stub(channel.get());
            hu::GetMultiFileReq req;
            hu::GetMultiFileRsp rsp;
            req.set_request_id(request->request_id());
            for (auto &user : users) {
        ...
        virtual void SetUserAvatar(::google::protobuf::RpcController* controller,
            const ::hu::SetUserAvatarReq* request,
            ::hu::SetUserAvatarRsp* response,
            ::google::protobuf::Closure* done){
            ...
            hu::FileService_Stub stub(channel.get());
            hu::PutSingleFileReq req;
            hu::PutSingleFileRsp rsp;
            req.set_request_id(request->request_id());
        ...
        virtual void SetUserNickname(::google::protobuf::RpcController* controller,
            const ::hu::SetUserNicknameReq* request,
            ::hu::SetUserNicknameRsp* response,
            ::google::protobuf::Closure* done){
        ...
        virtual void SetUserDescription(::google::protobuf::RpcController* controller,
            const ::hu::SetUserDescriptionReq* request,
            ::hu::SetUserDescriptionRsp* response,
            ::google::protobuf::Closure* done){
        ...
        virtual void SetUserPhoneNumber(::google::protobuf::RpcController* controller,
            const ::hu::SetUserPhoneNumberReq* request,
            ::hu::SetUserPhoneNumberRsp* response,
            ::google::protobuf::Closure* done){
